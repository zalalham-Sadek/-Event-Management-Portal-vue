<template>
    <button @click="toggleCollapse" class="hidden md:block  text-lg   py-1  hover:bg-accent hover:rounded-2xl">
        <span v-if="sidebarCollapsed" class="rounded-full ">
            <!-- Icon for collapsed state -->
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="text-[#008f32]">
