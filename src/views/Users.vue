<template>
  ...
  <div class="p-6 max-w-7xl mx-auto ">
    ...
    <headPage part="Users" title="overview" :enableBtn="true" btnTitle="Add User" href="/users/create" />
    ...
    <div class="col-span-12 md:col-span-6">
      <div
        ...
        <div v-else class="max-w-full overflow-x-auto shadow-md rounded-xl">
          <TableUsers 
            :colTitle="['Name', 'Email', 'Created At', 'Action']"
...
import TableUsers from '@/components/layout/ui/TableEvent.vue'
